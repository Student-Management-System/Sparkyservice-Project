...
//        Identity extendedUser = transformer.extractAndRefresh(userDetails).getIdentity(); // in reality this is maybe null!
//        assertAll(
//            () -> assertEquals("testuser", extendedUser.nickname()),
//            () -> assertEquals(UserRealm.MEMORY, extendedUser.realm())
//        );
//    }
//
//    @Test
...
//        assertDoesNotThrow(() -> transformer.extendAndRefresh());
//    }
//
//    @Test
...
//            () -> assertEquals(dto.realm, extendedUser.realm())
//        );
//    }
//
//    @Test
...
//            () -> assertEquals(UserRealm.LOCAL, extractedUser.realm()),
