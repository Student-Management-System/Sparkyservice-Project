...
//
///**
// * Tests for {@link JwtAuthTools} class. 
// * 
// * @author marcel
// */
...
//        String token = JwtAuthTools.createJwtToken(user, confValues);
//        assertDoesNotThrow(() -> JwtAuthTools.readJwtToken(token, confValues.getSecret()));
//    }
//
//    /**
...
//        String token = JwtAuthTools.createJwtToken(user, confValues);
//        
//        UsernamePasswordAuthenticationToken authToken = JwtAuthTools.readJwtToken(token, confValues.getSecret());
...
//        return JwtAuthTools.readJwtToken(token, confValues.getSecret());
//    }
//}
