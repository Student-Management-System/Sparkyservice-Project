...
public class StorageServiceImplDatabaseTests {
    ...
    public void _storeUserToDB() {
        ...
        LocalUserDetails user = (LocalUserDetails) realm.userFactory().create(testUserIdentity.nickname(), new Password("test", "PLAIN"),
    ...
    public void findMultipleEntriesUsingOnlyNickname() throws UserNotFoundException {
        var user = ldapRealm.userFactory().create(testUserIdentity.nickname(), new Password(""), UserRole.DEFAULT, true);
        storageService.commit(user);
