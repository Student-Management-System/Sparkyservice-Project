...
import net.ssehub.sparkyservice.api.persistence.DuplicateEntryException;
...
import net.ssehub.sparkyservice.api.useraccess.modification.UserEditException;
...
public class UserService {
    ...
    public UserDto createLocalUser(@Nonnull String nickname) throws UserEditException {
        try {
            SparkyUser newUser = createInDatabase(nickname);
    ...
    public SparkyUser createInDatabase(String nickname) {
        @SuppressWarnings("null")
        final SparkyUser newUser = LocalUserDetails.newLocalUser(nickname, realm, "", UserRole.DEFAULT);
