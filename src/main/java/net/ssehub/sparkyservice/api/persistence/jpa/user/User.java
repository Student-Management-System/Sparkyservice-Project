...
import net.ssehub.sparkyservice.api.persistence.LocalDateAttributeConverter;
...
public class User {
    ...
    @OneToOne(cascade = {CascadeType.ALL},
            targetEntity = net.ssehub.sparkyservice.api.persistence.jpa.user.PersonalSettings.class)
    @Nonnull
