...
class LdapProvider {
    ...
    @ConditionalOnExpression("${ldap.enabled:false} and !${ldap.ad:false}")
    public AuthenticationProvider authenticationProvider(LdapContextMapper mapper,
        BaseLdapPathContextSource contextSource) {
        String searchBase = "";
        FilterBasedLdapUserSearch search = new FilterBasedLdapUserSearch(searchBase, ldapUserDnPattern, contextSource);
