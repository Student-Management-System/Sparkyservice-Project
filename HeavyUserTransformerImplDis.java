...
// */
//@Service
//public class HeavyUserTransformerImplDis implements UserTransformerService {
//
//    @Autowired
...
//     */
//    @Override
//    public @Nonnull SparkyUser extendFromUserDetails(@Nullable UserDetails details) throws UserNotFoundException {
...
//     * {@inheritDoc}
//     */
//    public @Nonnull SparkyUser createMemoryUser(SparkyUser memoryUser) {
...
//     */
//    @Override
//    public @Nonnull SparkyUser extendFromSparkyPrincipal(@Nullable SparkysAuthPrincipal principal) 
...
//     */
//    @Override
//    public @Nonnull SparkyUser extendFromAnyPrincipal(@Nullable Object principal) ion {
...
//     */
//    @Override
//    public @Nonnull SparkyUser extendFromAuthentication(@Nullable Authentication auth) throws MissingDataException {
//        if (auth != null) {
...
//     */
//    @Override
//    public @Nonnull SparkyUser extendFromUserDto(@Nullable UserDto userDto) throws MissingDataException, UserNotFoundException {
