...
public class SessionFactoryHelper {
    ...
    /**
     * All wanted annotated classes for the session factory which should be set
     * before starting this application. This should be a type of
     * {@link AnnotatedClass}. As mentioned in the hibernate documentation, this is
     * a very heavy object why this is only build once inside the static
     * initializer.
     */
    private static final Class<?>[] ANNOTATED_CLASSES = { Password.class, PersonalSettings.class, StoredUser.class };

    /**
     * Creates a new {@link SessionFactory} and sets all anotatedClasses to the
     * session factory.
     */
    static {
        try {
